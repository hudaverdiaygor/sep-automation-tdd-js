...
export class ReviewPaymentPage extends BasePage {
  ...
  public readonly payButton: Locator = this.locator("button.next-button").filter({ hasText: "Pay" });
  ...
  public readonly successMessage: Locator = this.locator("p").filter({ 
      hasText: "You took the first step. Now let us show you the path." 
  });
